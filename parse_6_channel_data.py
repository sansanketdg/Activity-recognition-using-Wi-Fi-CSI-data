...
filename = glob.glob(path + "Falling*.txt")
...
# directory = filename[0].strip(".txt") + "/SVM_Data/"
...
while( START + (SIZE_OF_6CHANNEL_SET + SILENT) < FILE1_DATA_SIZE):
    sample = data_buffer1[START:START + SIZE_OF_6CHANNEL_SET]
    # plt.plot(sample, 'b')
    # plt.show()
